...
const staffMenuItems: Array<{
  ...
  { icon: FileStack, label: "考試範本", path: "/exam-templates", color: "purple", editorOnly: true },
  ...
  { icon: TrendingUp, label: "成績檢查板", path: "/scores-dashboard", color: "green", editorOnly: true },
