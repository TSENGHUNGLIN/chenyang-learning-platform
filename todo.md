...
## 當前任務：將編輯者權限管理整合到使用者管理頁面

- [x] 找出現有的編輯者權限管理功能（EditorPermissions相關）
- [x] 檢查資料庫架構中的editorDepartmentAccess和editorUserAccess表
- [x] 檢查相關的tRPC procedures（setDepartmentAccess, setUserAccess）
- [x] 權限設定功能已經整合在使用者管理頁面的「管理權限」按鈕中
- [x] 功能已完整實作，無需額外修改
